...
import neokapi.bridge.util.AnnotationExtractor;
import neokapi.bridge.util.OkapiCodeConverter;
import neokapi.bridge.util.SkeletonConverter;
...
/**
 * Converts Okapi Events to neokapi PartDTOs.
 *
...
public class EventConverter {
    ...
    /**
     * Convert an Okapi Event to a neokapi PartDTO.
     * Returns null for event types that don't map to neokapi parts.
     */
